...
router.post("/create-password-and-login", createPasswordAndLogin);

// Login
router.post("/login", loginDataValidators, loginDataValidatorResult, login);

// checkL logged in user
router.get("/checkLogIn", checkLogin, checkLoggedIn);
